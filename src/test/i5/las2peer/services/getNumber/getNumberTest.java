 ...
 * 208 - Test Class
 *
 * This class provides a basic testing framework for the microservice 208. It was
...
public class getNumberTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(getNumber.class.getCanonicalName(),"0.1");

  private static final String mainPath = "number";
  ...
  public void testgetNumber() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/number", "",
        MediaType.TEXT_PLAIN, MediaType.TEXT_PLAIN, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testgetNumber': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
